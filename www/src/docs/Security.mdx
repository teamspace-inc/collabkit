...
### Easy to integrate by default

By default CollabKit lets you use your API Key in the browser. This is great for development and testing, but not for production.

### Secure Mode for production

When you're ready to to production, you'll want to use CollabKit in "Secure Mode". This will ensure that your API Key is not exposed to the public.

With Secure Mode you'll need to sign a per-user token with your API Key and also pre-create a user and workspace via our API.
