...
The following example shows how to setup{' '} `<CollabKitProvider />` for your app. Copy the code below into your root `<App/>` component.
...
<AdvancedProps
  ...
  optionalProps={[
    [
      ...
      'Render a custom avatar component',
    ],
  ]}
/>
