...
This is the main component you'll use to enable comments on your React components. You'll want to place this throughout your app.

### Usage

Wrap components you'd like to enable comments to be placed on with a Commentable component.

The following example shows how to setup{' '} <code className="ReactNode">Commentable</code> for a component in your app.
