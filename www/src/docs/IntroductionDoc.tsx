...
export function IntroductionDoc() {
  return (
    <div>
      ...
      <p>
        Purpose built collaboration apps like Notion, Figma and Google Docs have offered commenting
        for many years now, but for the average app, building one is usually a significant
        undertaking, or one done to a bare-minimum standard which misses users expectations set by
        industry leading products.
      </p>
      <p>
        Our goal is to create a high-quality, easy-to-integrate commenting system, which helps your
        users collaborate effectively, in your product, with full context. So you can focus on your
        core value and meet your users expectations with minimal effort.
      </p>
      <H3>Key Features</H3>
      <ol>
        <li>
        ...
        <li>
          <p>
            ...
            and use our unstyled building blocks to create an entirely new commenting or
            collaboration experience completely integrated with your app.
          </p>
        </li>
        <li>
          <p>
