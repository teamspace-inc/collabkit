...
const MODE = ['justify', 'center', 'left', 'right'] as const;
...
export default class EnergySankey extends React.Component {
  ...
  updateModeIndex = (increment: boolean) => () => {
    ...
    return (
      <div className="centered-and-flexed">
        <div className="centered-and-flexed-controls">
          <button onClick={this.updateModeIndex(false)} type="button">
            PREV MODE
          </button>
          <div> {MODE[modeIndex]} </div>
          <button onClick={this.updateModeIndex(true)} type="button">
            NEXT MODE
          </button>
        </div>
        <Sankey
