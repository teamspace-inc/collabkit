...
describe('CenterHandle', () => {
  ...
  test('top left corner > validate attributes', () => {
    ...
    const cornerTransparent = screen.getByLabelText('top left corner handle')
    const cornerHandle = screen.getByTestId('corner-handle')
  ...
  test('top right corner > validate attributes', () => {
    ...
    const cornerTransparent = screen.getByLabelText('top right corner handle')
    const cornerHandle = screen.getByTestId('corner-handle')
  ...
  test('bottom left corner > validate attributes', () => {
    ...
    const cornerTransparent = screen.getByLabelText('bottom left corner handle')
    const cornerHandle = screen.getByTestId('corner-handle')
  ...
  test('bottom right corner > validate attributes', () => {
    ...
    const cornerTransparent = screen.getByLabelText('bottom right corner handle')
    const cornerHandle = screen.getByTestId('corner-handle')
